      ...
      <body className={`${openSans.className} antialiased`}>
        ...
        <nav className="bg-[#5b60ff] p-4 shadow-md fixed top-[32px] left-0 w-full z-40">
          <ul className="flex justify-center gap-8">
            ...
            <li className="text-sm font-normal text-white hover:font-bold hover:text-black active:text-violet-300 cursor-pointer">TARIFAS</li>
            <li className="text-sm font-normal text-white hover:font-bold hover:text-black active:text-violet-300 cursor-pointer">MÁS INFORMACIÓN</li>
            ...
            <li className="text-sm font-normal text-white hover:font-bold hover:text-black active:text-violet-300 cursor-pointer">SEGURIDAD¿?</li>
          </ul>
        </nav>
